...
There are two ways to integrate Praxis: 
- [Embed](https://mintlify.com/docs/api-playground/openapi/setup) 
- [SDK](https://mintlify.com/docs/api-playground/mdx/configuration). 


<Columns cols={2}>
  <Card title="Embed" icon="pen-to-square" href="https://www.canva.com/design/DAGvVkyaSJY/qMHI8e4n3_cm0Gv45p7PuA/watch?utm_content=DAGvVkyaSJY&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=he80f2f6101">
    Learn how to communicate with your AI digital twin.
  </Card>
  <Card title="JavaScript SDK" icon="waveform-lines" href="https://www.canva.com/design/DAGvbzNRJ3k/0qd_jIvfAyFqLTnmOis91w/watch?utm_content=DAGvbzNRJ3k&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h7a33588f3b">
...
Install Pria on your Website using the custom SDK https://pria.praxislxp.com/pria-sdk-web.js

<Note>To install Pria as a Theme into Canvas https://learning.praxislxp.com/praxis/pria-custom-theme-canvas-install-guide</Note>
...
Pria outputs content in Markdown format. See more at https://en.wikipedia.org/wiki/Markdown

Note: The value of the usage property indicates the total number of tokens used by this query (input + output)