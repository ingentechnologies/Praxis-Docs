...
![Praxis AI \+ Canvas Integration Introduction](/images/integrations/canvas/theme/canvas-introduction.png)
  ...
  <Accordion title="Step 2. Edit Canvas Theme and Upload SDK">
    <Steps>
      <Step title="Navigate to Admin Settings">
        ...
        ![Edit Canvas Theme](/images/integrations/canvas/theme/canvas-admin-navigate.png)
      </Step>
      <Step title="Select Themes">
        Click on the current Theme to open the Theme Editor.

        ![Edit Canvas Theme](/images/integrations/canvas/theme/canvas-select-theme.png)
      </Step>
      <Step title="Open Theme Editor">
        Click on the "Edit" button to open the Theme Editor.

        ![Edit Canvas Theme](/images/integrations/canvas/theme/canvas-open-editor.png)
      </Step>
      <Step title="Upload Tab">
        Click to the Upload tab on the left.

        ![Edit Canvas Theme](/images/integrations/canvas/theme/canvas-theme-upload.png)
      </Step>
    </Steps>
...
<img
  src="/images/integrations/canvas/theme/canvas-expert-icon.png"
  alt="Instance Icon"
  style={{ width:"20%" }}
/>
...
![Onboarding Wizard](/images/integrations/canvas/theme/canvas-subaccounts.png)
...
![Onboarding Wizard](/images/integrations/canvas/theme/canvas-start-new.png)

Click the \+ Digital Twin button to create a personalized instance of Pria.

![Onboarding Wizard](/images/integrations/canvas/theme/canvas-new-digital-twin.png)
...
![Onboarding Wizard](/images/integrations/canvas/theme/canvas-integration-complete.webp)
...
![Onboarding Wizard](/images/integrations/canvas/theme/canvas-get-connected.png)
...
![Onboarding Wizard](/images/integrations/canvas/theme/canvas-more-personalization.webp)
