...
- **Remote MCP Support**: Added comprehensive support for Remote Model Context Protocol (MCP) servers, individually configurable for each Digital Twin instance to enable distributed AI capabilities
...
- **Support for Mermaid diagrams and charts**: Added support for [Mermaid Diagramming and Charting](https://mermaid.js.org/)
</Update>
