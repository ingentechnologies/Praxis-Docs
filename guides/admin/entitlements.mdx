...
![Praxis AI Expert Galler Details](/images/admin/admin-entitlements.webp)

You can configure permissions to prevent student users from accessing the administrative dashboard, limiting their interaction to only the learning environment.
