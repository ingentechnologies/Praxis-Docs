...
![Praxis AI Expert Galler Details](/images/guides/admin/admin-histories.webp)
...
![Praxis AI Expert Galler Details](/images/guides/admin/admin-histories-summarize.webp)

Select the instance you want to summarize, then click the ‘Summarize’ button on the bottom of the conversation history page.

![Praxis AI Expert Galler Details](/images/guides/admin/admin-histories-summary.webp)
...
![Praxis AI Expert Galler Details](/images/guides/admin/admin-histories-metrics.webp)
...
![Praxis AI Expert Galler Details](/images/guides/admin/admin-histories-edit.webp)
