...
![Admin Histories](/images/guides/admin/admin-histories.webp)
...
![Admin Histories Summarize](/images/guides/admin/admin-histories-summarize.webp)

Select the instance you want to summarize, then click the ‘Summarize’ button on the bottom of the conversation history page.

![Admin Histories Summary](/images/guides/admin/admin-histories-summary.webp)
...
![Admin Histories Metrics](/images/guides/admin/admin-histories-metrics.webp)
...
![Admin Histories Edit](/images/guides/admin/admin-histories-edit.webp)
