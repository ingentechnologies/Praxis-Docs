...
```text Response icon=message-bot wrap
...
<Note>
  Please note that in your question, you can specify a target audience, a tone (with humor, professional, etc.) and any guidelines, as to length, nature of the content, etc. The more detailed and specific, the better the outcome.
</Note>
...
<Info>
  I remember our previous interactions so that your questions can build on each other\!
</Info>
