...
<Note>
  Disable File Upload for Users: You may choose to disable File upload to prevent users from uploading files. Don't worry, as administrator, you can still upload files for your instance.
</Note>