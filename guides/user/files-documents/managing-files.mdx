...
<Steps>
  <Step title="Click Files on the Text Input Bar">
    ![Files Main Ui Location Web](/images/files-main-ui-location.webp)
  </Step>
  <Step title="Add File(s)">
    You will be brought to your IP Vault. From here, you can click \+ Add at the bottom of the page.
  ...
  <Step title="Choose File(s)">
    ![Files Add Options Web](/images/files-add-options.webp)

    You have the option to:

    1.  Upload files from your computer
    2. Upload a file using a URL
    3. Copy and paste a file from your clipboard
  </Step>
  <Step title="Upload File(s)">
    Use your device’s file manager to choose the desired file.

    Click **Upload** to begin the upload process, then click **Done **in the lower-left corner.

    A progress indicator will appear below. Once the files are uploaded, ingestion will begin and may take several minutes to complete.
  ...
  <Step title="Files are Available in IP Vault">
