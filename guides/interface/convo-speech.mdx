...
<CardGroup cols={2}>
  ...
  <Card title="Cultural Adaptation" icon="users">
    It even understands when bilingual speakers naturally mix languages, and it adapts its responses to fit the cultural context of whatever language you're using.
  </Card>
...
<AccordionGroup>
  <Accordion title="Microphone not working" icon="microphone">
    Check permissions and hardware connections. Your microphone needs to be enabled in the platform for convo mode to work
  </Accordion>
  ...
  <Accordion title="Context lost" icon="clock">
    Provide brief recap of previous discussion to your digital twin and pick up from there
  </Accordion>
