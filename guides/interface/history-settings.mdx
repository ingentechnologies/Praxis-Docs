...
<AccordionGroup>
  ...
  <Accordion title="Settings" icon="message">
    ...
    **Max Dialogues:**	Determine the maximum number of dialogue to load in your history pane. Too many dialogs may impact performance of the UI, while not enough limit the number of dialogs you can scroll back to. Use 25 by default.
...
![Conversation Titles Web](/images/conversation-titles.webp)
