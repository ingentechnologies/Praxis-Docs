...
Praxis AI is a subscription based service with a free starter plan and several paid plans. When you pay for a subscription you get access to more features, and more credits. You need credits to send messages in Praxis AI.

<Note>Praxis AI is a paid service. You can use the free starter plan with 50 free credits to try out the service, but you will need to pay for a subscription to use it long term.</Note>
